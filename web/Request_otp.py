    ...
    def send_email(self, email, otp):
        ...
        <body>
            <h1>Welcome to Codegnan Destination!!</h1>
                <p>Email verification for Quick-Request-A-Callback!.Your one time password(OTP):-<b style="font-size:25px">{ otp }</b></p>
        ...
        subject = "One Time password for Codegnan!"
